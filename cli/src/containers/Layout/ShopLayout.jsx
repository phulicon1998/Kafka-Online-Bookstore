        ...
        <div className='container'>
          <div className='row'>
            <div className='col-md-4'>
              <Logo bigger />
              <p>
                Our mission to give the customers opportunity to enjoy
                high-quality services to order and receive the best books.
