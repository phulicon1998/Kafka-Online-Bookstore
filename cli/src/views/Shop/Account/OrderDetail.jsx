...
const BookInOrder = ({cover, edition_id, price, discount, quantity}) => (
    <div className="row">
        ...
        <div className="col-md-4">
            <div className="price">
                <p>$ {(price * quantity * (100 - discount) / 100).toFixed(2)} {quantity > 1 && `(${quantity})`} <span>$ {(price*quantity).toFixed(2)}</span> <span>-{discount}%</span></p>
    ...
    return (
        <Loader loading={loading}>
            <div className="order-detail-section">
                ...
                <p>
                    Status: <b className={statusToString(order.status)}>
                ...
                <div className="col-md-4">
                    <div className="order-detail-info">
                        ...
                        <div className="deliveryPayment">
                            <h5><i className="fas fa-caret-down"/> Delivery & payment</h5>
